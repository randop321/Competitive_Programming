...
In order to speed up, I combine the three vars value (node value), cnt (the number of nodes in the tree), rand (a random number used in treap) into one Int as v = value * (2**36) + cnt * (2**18) + rand.
